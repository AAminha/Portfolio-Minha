...
- [tailwind 관련 prettier 적용](https://github.com/tailwindlabs/prettier-plugin-tailwindcss)
...
- [Next.js에서 메타데이터 설정 & 최적화 기법](https://reactnext-central.xyz/blog/nextjs/metadata)
